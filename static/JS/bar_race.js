   ...
   const update = (year_period) =>  {
      ...
      //print ticker
       ...
       //legend
        ...
        legend.append("rect").attr("x",1065).attr("y",630).attr("width",15).attr("height",15).style("fill", "green")
        legend.append("rect").attr("x",1065).attr("y",650).attr("width",15).attr("height",15).style("fill", "blue")
        legend.append("rect").attr("x",1065).attr("y",670).attr("width",15).attr("height",15).style("fill", "yellow")
        legend.append("rect").attr("x",1065).attr("y",690).attr("width",15).attr("height",15).style("fill", "orange")
        legend.append("rect").attr("x",1065).attr("y",710).attr("width",15).attr("height",15).style("fill", "red")
        legend.append("text").attr("x", 1080).attr("y", 640).text("<$300K").style("font-size", "15px").attr("alignment-baseline","middle")
        legend.append("text").attr("x", 1080).attr("y", 660).text("$300K+").style("font-size", "15px").attr("alignment-baseline","middle")
        legend.append("text").attr("x", 1080).attr("y", 680).text("$400K+").style("font-size", "15px").attr("alignment-baseline","middle")
        legend.append("text").attr("x", 1080).attr("y", 700).text("$500K+").style("font-size", "15px").attr("alignment-baseline","middle")
        legend.append("text").attr("x", 1080).attr("y", 720).text("$600K+").style("font-size", "15px").attr("alignment-baseline","middle")
